...
public class Consumer {
    public static void main(String[] args) {
        new ConsumerThread("tcp://192.168.1.146:61616", "queue1","1").start();
        new ConsumerThread("tcp://192.168.1.146:61616", "queue1","2").start();
    }
}
...
class ConsumerThread extends Thread {
    ...
    public ConsumerThread(String brokerUrl, String destinationUrl, String name) {
